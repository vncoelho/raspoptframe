...
//		r = APEN_SI_DemandForecasting(argc, argv);
	...
	case 3: //James Taylor 2007
		...
		cout
				<< "Program ended successfully in James Taylor Eurpean Dataset Mode"
				<< endl;
		return r;
		break;
	...
	case 69: //James Taylor 2007
		...
		cout
				<< "Program ended successfully in Mokoko's place configuration! \n Ziiz Gud ! \n A naice to meet you ! \n Godbye"
				<< endl;
		return r;
		break;
	...
	default:
		...
		cout
				<< "Program ended unsuccessfully in DEFAULT Mode! Something went wrong...."
				<< endl;
		return r;
	}
